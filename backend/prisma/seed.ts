...
const PRODUCTS = [
  {
    ...
    description:
      "Infinity is not a barrier — it's a statement. 240 GSM ring-spun cotton. Pre-shrunk. DTG printed.",
    price: 899,
    comparePrice: 1199,
...
async function main() {
  ...
  const coupons = [
    { code: "OTAKU10", type: CouponType.percent, discount: 10, minOrder: 0 },
    { code: "ANIME20", type: CouponType.percent, discount: 20, minOrder: 999 },
    { code: "NEWAV15", type: CouponType.percent, discount: 15, minOrder: 500 },
    { code: "FLAT100", type: CouponType.flat, discount: 100, minOrder: 1500, active: false },
  ];
